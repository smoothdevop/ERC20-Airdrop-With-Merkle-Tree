...
function main() {
  ...
  const filename = "scripts/merkle_proof/csv/token_claimers.csv";

  // what file should we write the merkel proofs too?
  const output_file = "scripts/merkle_proof/outputs_file/permitted_claim.json";

  //file that has the user claim list
  const userclaimFile =
    "scripts/merkle_proof/outputs_file/token_claimlist.json";

  //contract of items being sent out
  const airdropContract = "0x4D97DCd97eC945f40cF65F87097ACe5EA0476045";
